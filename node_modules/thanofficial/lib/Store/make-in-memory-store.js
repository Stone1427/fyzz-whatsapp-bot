...
fetchImageUrl: async (jid, izumi) => {
const contact = contacts[jid]
if (!contact) {
return izumi?.profilePictureUrl(jid)
}
if (typeof contact.imgUrl === 'undefined') {
contact.imgUrl = await izumi?.profilePictureUrl(jid)
}
return contact.imgUrl
},
fetchGroupMetadata: async (jid, izumi) => {
if (!groupMetadata[jid]) {
const metadata = await izumi?.groupMetadata(jid)
if (metadata) {
...
fetchBroadcastListInfo: async (jid, izumi) => {
if(!groupMetadata[jid]) {
const metadata = await izumi?.getBroadcastListInfo(jid)
if(metadata) {
groupMetadata[jid] = metadata
}
}
